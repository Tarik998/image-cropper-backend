-- Minimal Image Cropper Database Schema
-- Only essential table for configuration storage

-- Essential database schema for image cropper application
...
CREATE TABLE IF NOT EXISTS cropping_configs (
  ...
  logo_image TEXT, -- Base64 encoded logo image
